        ...
        <div style={{
          ...
          <div style={{ padding: '20px', display: 'flex', flexDirection: 'column', gap: 16 }}>
            ...
            <div>
              ...
              <input
                type="text" placeholder="cth: Budi Santoso" value={form.name}
            ...
            <div>
              ...
              <input
                type="text" placeholder="cth: Kepala Gudang" value={form.jabatan}
            ...
            <div>
              ...
              <input
                type="tel" placeholder="cth: 08123456789" value={form.phone}
                onChange={e => setForm(f => ({ ...f, phone: e.target.value }))}
                style={inputStyle}
              />
            </div>

            <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', padding: '10px 12px', border: '1.5px solid #e2e8f0', borderRadius: 10, background: 'white' }}>
              ...
              >
                <div style={{
                  ...
                  left: form.active ? 21 : 3, width: 20, height: 20,
    ...
    <div style={{ display: 'flex', flexDirection: 'column', gap: 20, fontFamily: "-apple-system, BlinkMacSystemFont, 'SF Pro Text', system-ui, sans-serif" }}>
      ...
      <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', gap: 12 }}>
        <div style={{ position: 'relative' }}>
          ...
          <input
            value={search} onChange={e => setSearch(e.target.value)} placeholder="Cari karyawan..."
              ...
              <tr style={{ background: '#f8fafc', borderBottom: '1px solid #f1f5f9' }}>
                {['Nama', 'Jabatan', 'Role', 'Telepon', 'Status', ...(canEdit ? ['Aksi'] : [])].map((h, i) => (
                  <th key={h} style={{
                    ...
                    textAlign: i === (canEdit ? 5 : 4) ? 'center' : 'left',
                  }}>{h}</th>
                ))}
              </tr>
            </thead>
                ...
                return (
                  <tr key={emp.id}
                    ...
                    <td style={{ padding: '12px 16px' }}>
                      <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
                        <div style={{
                          ...
                          background: `linear-gradient(135deg, ${rc.text}, ${rc.text}88)`,
                          display: 'flex', alignItems: 'center', justifyContent: 'center',
                    ...
                    <td style={{ padding: '12px 16px', color: '#64748b', fontSize: 13 }}>
                      {emp.jabatan || <span style={{ color: '#cbd5e1' }}>–</span>}
                    </td>
                    {/* Role */}
                    <td style={{ padding: '12px 16px' }}>
                      <span style={{ fontSize: 11.5, fontWeight: 600, padding: '3px 10px', borderRadius: 99, background: rc.bg, color: rc.text }}>
                        {rc.label}
                      </span>
                    </td>
                    {/* Telepon */}
                    ...
                    <td style={{ padding: '12px 16px' }}>
                      <span style={{
                        ...
                        background: emp.active ? '#f0fdf4' : '#f8fafc',
                        color: emp.active ? '#16a34a' : '#94a3b8',
                        border: `1px solid ${emp.active ? '#bbf7d0' : '#e2e8f0'}`,
                      }}>
                    ...
                    {canEdit && (
                      <td style={{ padding: '12px 16px', textAlign: 'center' }}>
                        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 2 }}>
                          ...
                          <button onClick={() => setShowDeleteConfirm(emp.id)} title="Hapus"
      ...
      {showEditModal && (
        <EmployeeModal
          title="Edit Karyawan"
          onClose={() => { setShowEditModal(false); setEditId(null); setFormError('') }}
          onSave={handleEdit}
        />
      )}
          ...
          <div style={{
            ...
            <div style={{ padding: '24px 20px 16px' }}>
              ...
              <p style={{ fontSize: 13.5, color: '#64748b', margin: 0, lineHeight: 1.5 }}>
                Data karyawan ini akan dihapus permanen dan tidak bisa dikembalikan.
              </p>
            </div>
            <div style={{ borderTop: '1px solid #f1f5f9' }}>
              ...
              <button onClick={() => setShowDeleteConfirm(null)} style={{
                display: 'block', width: '100%', padding: '13px',
                background: 'none', border: 'none', cursor: 'pointer',
                fontSize: 15, color: '#2563eb', fontFamily: 'inherit',
              }}>
                Batal
              </button>
            </div>
